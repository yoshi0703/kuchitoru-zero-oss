  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        variants={getVariant(variants, 'left')}
        initial="initial"
        animate={controls}
      />
      {/* Right arc */}
      <motion.path
        ...
        variants={getVariant(variants, 'right')}
        initial="initial"
        animate={controls}
      />
      {/* Middle line */}
      <motion.line
        ...
        variants={getVariant(variants, 'middle')}
        initial="initial"
        animate={controls}
      />
      ...
      <motion.g style={{ rotate: 45, transformOrigin: '12px 12px' }}>
        <motion.line
          ...
          variants={getVariant(variants, 'burstTop')}
          initial="initial"
          animate={controls}
        />
        <motion.line
          ...
          variants={getVariant(variants, 'burstLeft')}
          initial="initial"
          animate={controls}
        />
        <motion.line
          ...
          variants={getVariant(variants, 'burstBottom')}
          initial="initial"
          animate={controls}
        />
        <motion.line
          ...
          variants={getVariant(variants, 'burstRight')}
          initial="initial"
          animate={controls}
        />
      </motion.g>
