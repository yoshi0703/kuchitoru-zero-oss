...
type DefaultIconProps<T = string> = {
  animate?: TriggerProp<T> | undefined;
  animateOnHover?: TriggerProp<T> | undefined;
  animateOnTap?: TriggerProp<T> | undefined;
  animateOnView?: TriggerProp<T> | undefined;
  animateOnViewMargin?: UseInViewOptions['margin'] | undefined;
  animateOnViewOnce?: boolean | undefined;
  animation?: T | StaticAnimations | undefined;
...
function getSvgProps<T>({
  ...props
}: IconProps<T>): Omit<SVGMotionProps<SVGSVGElement>, 'animate'> {
  const svgProps = { ...props };
  delete svgProps.animate;
  delete svgProps.animateOnHover;
  delete svgProps.animateOnTap;
  delete svgProps.animateOnView;
  delete svgProps.animateOnViewMargin;
  delete svgProps.animateOnViewOnce;
  delete svgProps.animation;
  delete svgProps.loop;
  delete svgProps.loopDelay;
  delete svgProps.initialOnAnimateEnd;
  delete svgProps.completeOnStop;
  delete svgProps.persistOnAnimateEnd;
  delete svgProps.delay;
  return svgProps;
}
