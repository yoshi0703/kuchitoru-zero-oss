          ...
          <AnimatePresence initial={false} mode="wait">
            {boundsState && (
              <motion.div
                ...
                transition={transition}
                style={{ position: 'absolute', zIndex: 0, ...style } as unknown as NonNullable<React.ComponentProps<typeof motion.div>['style']>}
            ...
            {isActive && !isDisabled && (
              <motion.div
                ...
                style={{
                  ...
                  ...contextStyle,
                  ...style,
                } as unknown as NonNullable<React.ComponentProps<typeof motion.div>['style']>}
