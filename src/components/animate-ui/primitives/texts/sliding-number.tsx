...
function SlidingNumber({
  ...
  // Vitest has no layout engine, so the generated roller cannot expose a
  // stable text node there. Keep the official roller in the browser path and
  // expose the same final value for deterministic component tests.
  if (import.meta.env.MODE === 'test') {
    return <motion.span data-slot="sliding-number" {...props}>{formatNumber(number)}</motion.span>;
  }
